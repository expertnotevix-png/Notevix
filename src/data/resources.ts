...
export const resourcesData: { resources: Chapter[] } = {
  resources: [
    // Class 8
    {
      id: "c8_science",
      class: "8",
      subject: "science",
      title: "Science Full Resources",
      summary: "Complete set of revision notes and questions for Class 8 Science.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "8",
      subject: "sst",
      title: "Social Studies Materials",
      summary: "In-depth notes and exam questions for Class 8 SST.",
      isPremium: false,
    ...
    },
    {
      ...
      summary: "Solutions, formulas and practice sets for Class 8 Maths.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "8",
      subject: "english",
      title: "English Comprehensive",
      summary: "Revision notes and practice questions for Class 8 English.",
      isPremium: false,
    ...
    // Class 9
    {
      ...
      class: "9",
      subject: "science",
      title: "Science Revision Hub",
      summary: "Class 9 Science one-page notes and important question banks.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "9",
      subject: "sst",
      title: "Social Science Guide",
      summary: "Comprehensive history, civics and geography notes for Class 9.",
      isPremium: false,
    ...
    },
    {
      ...
      summary: "Formula sheets and practice questions for Class 9 Mathematics.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "9",
      subject: "english",
      title: "English Study Kit",
      summary: "Revision notes and sample questions for Class 9 English.",
      isPremium: false,
    ...
    // Class 10
    {
      ...
      class: "10",
      subject: "science",
      title: "Board Exam Science Prep",
      summary: "Class 10 Science high-yield notes and board questions.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "10",
      subject: "sst",
      title: "Board SST Summary",
      summary: "Complete Social Science syllabus in Revision notes & question banks.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "10",
      subject: "maths",
      title: "Maths Board Readiness",
      summary: "Class 10 Maths important questions and quick revision formula sheets.",
      isPremium: false,
    ...
    },
    {
      ...
      class: "10",
      subject: "english",
      title: "English Board Kit",
      summary: "Board-focused notes and literature questions for Class 10 English.",
      isPremium: false,
