        ...
        {!isSunday ? (
          ...
          <div className="glass-card p-4 rounded-2xl border-purple-500/30 bg-purple-500/5 space-y-3">
            ...
            <p className="text-sm text-gray-300">
              The <span className="text-yellow-400 font-bold">Top 3 students</span> of the week will be tagged on our Instagram accounts today!
            </p>
