...
import { Trophy, Medal, Crown, Timer, TrendingUp } from 'lucide-react';
...
export default function Leaderboard({ user }: LeaderboardProps) {
  ...
  return (
    <div className="p-6 space-y-8 pb-24">
        ...
        {topUsers[0] && (
          ...
          >
            <div className="relative">
              ...
              <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-yellow-400 shadow-xl shadow-yellow-400/20">
      ...
      {/* User's Current Rank (if not in top 20) */}
